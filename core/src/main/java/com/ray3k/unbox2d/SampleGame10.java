...
public class SampleGame10 extends ApplicationAdapter {
    ...
    public void create() {
        ...
        new SpriteBehavior(web, -9.5f, 8, sprite);
        ...
        new SpriteBehavior(web, 8.5f, -9, sprite);
        ...
        new SpriteBehavior(web, -9.5f, -9, sprite);
    }
